...
export default function HeroSection() {
  return (
    <div className="bg-white text-[#1D1B4F] px-9 lg:px-0 lg:max-w-7xl mx-auto py-24  lg:py-24 xl:pt-32 justify-center flex ">
      <div className="container  flex flex-col md:flex-row items-center justify-center ">
        <div className="xl:w-1/2 lg:w-2/3">
          <h1 className="text-[3rem] lg:text-[5rem]  font-bold mb-4 leading-tight">
        ...
        <div className=" lg:mt-[-62px] lg:w-[35%]  ">
