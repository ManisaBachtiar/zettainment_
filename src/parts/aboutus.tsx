...
const AboutUs: React.FC = () => {
    return (
        <div className="flex justify-between max-w-7xl flex-col md:flex-row  lg:px-16 px-9 mx-auto mt-9 bg-another py-11">
        <div className="md:w-1/2 justify-center items-center flex  w-2/3 mx-auto lg:mx-0 lg:mt-9 lg:pb-0 pb-12 lg:px-5">
            <img src={about_image} alt="" className="w-full animate-fly" />
        </div>
        <div className="md:w-1/2 ml-4  lg:px-4">
            ...
            <Button variant="outline" className="bg-another border-2 border-[#ECC50D] text-foreground font-bold py-2 px-4 rounded">
            Our Content
            </Button>
        </div>
        </div>
